      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="relative">
            ...
            >
              ...
              {/* Stylized G */}
              <span className="relative z-10 text-bg text-xl sm:text-2xl font-black italic tracking-tighter">G</span>
          ...
          <div className="flex flex-col -space-y-1">
            <span className="text-white font-black text-lg sm:text-2xl tracking-tighter group-hover:text-brand transition-colors duration-300 uppercase">
              Gaurav<span className="text-brand group-hover:text-white">Raj</span>
            </span>
            <span className="text-[8px] sm:text-[10px] font-mono font-bold text-slate-500 uppercase tracking-[0.3em] group-hover:text-slate-300 transition-colors">
              Upcoming System Engineer @ Infosys
            </span>
          </div>
        </motion.div>
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8">
          ...
          <div className="flex items-center gap-3 lg:gap-4">
            <a href="https://github.com/Gauravs1104" target="_blank" className="p-2 text-slate-400 hover:text-white transition-all hover:scale-110 glass rounded-lg">
              <Github size={18} />
            </a>
            <a 
              href="#contact" 
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="mt-auto flex gap-6 pb-12">
              <a href="https://github.com/Gauravs1104" className="p-5 glass rounded-2xl text-slate-400 hover:text-brand transition-colors"><Github size={28} /></a>
              <a href="https://www.linkedin.com/in/gaurav-raj-750278213" className="p-5 glass rounded-2xl text-slate-400 hover:text-brand transition-colors"><Linkedin size={28} /></a>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
