      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          ...
          <div className="flex gap-6">
            {[
              { icon: <Github size={20} />, url: "https://github.com/Gauravs1104", label: "Github" },
              { icon: <Linkedin size={20} />, url: "https://www.linkedin.com/in/gaurav-raj-750278213", label: "LinkedIn" },
              { icon: <Mail size={20} />, url: "mailto:gauravraj11.11.2004@gmail.com", label: "Email" }
            ].map((social, i) => (
              <a 
                key={i}
                href={social.url}
