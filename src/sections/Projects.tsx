...
const projects = [
  {
    ...
    github: 'https://github.com/Gauravs1104',
            ...
            >
              <div className="relative aspect-[16/9] overflow-hidden m-4 rounded-[2rem]">
                <img 
                  src={project.image} 
                  alt={project.title} 
                  className="w-full h-full object-cover grayscale hover:grayscale-0 active:grayscale-0 group-hover:scale-110 transition-all duration-700 opacity-60 group-hover:opacity-100 cursor-pointer"
                />
