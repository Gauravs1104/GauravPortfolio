        ...
        <div className="lg:col-span-7 order-2 lg:order-1">
          ...
          >
            ...
            <p className="max-w-xl text-slate-400 text-sm sm:text-lg md:text-xl lg:text-2xl mb-10 sm:mb-14 leading-relaxed font-medium">
              Architecting scalable digital solutions at <span className="text-white border-b-2 sm:border-b-4 border-brand/20">KIIT Bhubaneswar</span>. 
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center justify-center gap-4 mt-2 sm:mt-0 sm:ml-2">
                <a href="https://github.com/Gauravs1104" className="p-3 sm:p-4 glass rounded-xl text-slate-400 hover:text-brand transition-all"><Github size={20} /></a>
                <a href="https://www.linkedin.com/in/gaurav-raj-750278213" className="p-3 sm:p-4 glass rounded-xl text-slate-400 hover:text-brand transition-all"><Linkedin size={20} /></a>
              </div>
            </div>
          </motion.div>
        </div>
